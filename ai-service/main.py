...
# Add the current directory to the PATH for this script run only
# This allows the script to find 'ffmpeg.exe' right next to it
...
async def transcribe_audio(file: UploadFile = File(...)):
    """
    Receives an audio file (blob), saves it temporarily, 
    and transcribes it using local Whisper.
    """
