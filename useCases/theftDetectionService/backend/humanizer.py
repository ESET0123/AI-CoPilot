...
logger = logging.getLogger("TheftDetectionService.Humanizer")

HUMAN_SYSTEM_PROMPT = """
You are a helpful assistant for a utility inspection (theft detection) bot.
...
- If the result is a list, summarize it (e.g., "I found 5 cases..." rather than listing all if too many).
